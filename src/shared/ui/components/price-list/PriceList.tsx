...
export const PriceList = ({ image }: { image: string }) => {
  const t = useTranslations("pricelist");

  return (
    <section className={styles.price_list}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={image} alt="" className={styles.price_list__bg} />
      <div className={styles.price_list__overlay}></div>
      <motion.div
        className={styles.price_list__container}
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <Link href="/pricing_theinsigmark.pdf" className={styles.price_list__link}>
