...
import styles from './ContactProjectFormSuccess.module.scss';
...
type ContactProjectFormSuccessProps = {
  isOpen: boolean;
  onClose: () => void;
};

export const ContactProjectFormSuccess = ({ isOpen, onClose }: ContactProjectFormSuccessProps) => {
  ...
  return (
    <FormPopup
      isOpen={isOpen}
      onClose={handleClose}
      ariaLabelledBy="contact-project-success-title"
      panelClassName={styles.panel}
    >
      <div className={styles.content}>
        <h2 id="contact-project-success-title" className={styles.title}>
          {t('successTitle', { fallback: 'Thank you!' })}
        </h2>
        <p className={styles.description}>
          {t('successDescription', {
            fallback:
              'Your request has been submitted successfully. Our team will review your message and get back to you shortly.',
          })}
        </p>
