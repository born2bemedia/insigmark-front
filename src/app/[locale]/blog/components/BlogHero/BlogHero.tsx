        ...
        <div className={styles.hero__inner}>
          <div className={styles.hero__content}>
            <h1 className={styles.hero__title}>
              {t('heroTitle', { fallback: 'Blog & Insights' })}
            </h1>
            <p className={styles.hero__desc}>
              {t('heroDescription', {
                fallback:
                  'Market trends, technical guides, and practical insights on web development, hosting, security, and digital infrastructure. Stay informed about the technologies shaping the web and discover strategies to make your website faster, safer, and more effective.',
              })}
            </p>
          </div>
          <a href="#blog-insights" className={styles.hero__link}>
            <span className={styles.hero__link_icon}>
              <ArrowIcon />
            </span>
            <span>{t('exploreArticles', { fallback: 'Explore Articles' })}</span>
          </a>
        </div>
      </div>
    </section>
