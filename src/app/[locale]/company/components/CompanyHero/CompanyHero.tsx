...
export const CompanyHero = () => {
  ...
  return (
    <section className={styles.company_hero}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/company/hero-bg.png"
        alt=""
        aria-hidden="true"
        className={styles.company_hero__bg}
      />
      <div className={styles.company_hero__container}>
        <motion.h1
          className={styles.company_hero__title}
          initial="hidden"
          animate="visible"
          variants={fadeInUpLyniq}
        >
          {t("heroTitle", { fallback: "Insigmark" })}
        </motion.h1>
        <motion.p
          className={styles.company_hero__subtitle}
          initial="hidden"
          animate="visible"
          variants={fadeInUpLyniq}
        >
          {t("heroSubtitle", {
            fallback:
              "We build and host websites as complete systems. Development, infrastructure, security, and long-term support are handled together to keep your website fast, stable, and ready to grow.",
          })}
        </motion.p>
        <motion.div
          className={styles.company_hero__buttons}
          initial="hidden"
          animate="visible"
          variants={fadeInUpLyniq}
        >
          <Link
            ...
            className={styles.company_hero__btn_primary}
          >
